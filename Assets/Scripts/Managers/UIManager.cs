...
public class UIManager : MonoBehaviour
{
        ...
        if (lobbyPanel.activeSelf)
        {
            if (GameManager.instance.diamondRewardTakeNum < 6)
            {
                ...
                if (diamondAdTimeLeft >= 60.0f)
                    lobbyAdDiamondText.text = ((int)(diamondAdTimeLeft / 60.0f)).ToString() + "m 후 획득\n" + GameManager.instance.diamondRewardTakeNum.ToString() + "/5";
                else if (diamondAdTimeLeft > 0.0f)
                    lobbyAdDiamondText.text = ((int)diamondAdTimeLeft).ToString() + "s 후 획득\n" + GameManager.instance.diamondRewardTakeNum.ToString() + "/5";
                else if (diamondAdTimeLeft <= 0.0f) lobbyAdDiamondText.text = "획득 가능!\n" + GameManager.instance.diamondRewardTakeNum.ToString() + "/5";
            }
            else lobbyAdDiamondText.text = "획득 완료\n5/5";
            if (GameManager.instance.boostRewardTakeNum < 6)
            {
                ...
                if (boostAdTimeLeft >= 60.0f)
                    lobbyAdBoostText.text = ((int)(boostAdTimeLeft / 60.0f)).ToString() + "m 후 획득\n" + GameManager.instance.boostRewardTakeNum.ToString() + "/5";
                else if (boostAdTimeLeft > 0.0f)
                    lobbyAdBoostText.text = ((int)boostAdTimeLeft).ToString() + "s 후 획득\n" + GameManager.instance.boostRewardTakeNum.ToString() + "/5";
                else if (boostAdTimeLeft <= 0.0f) lobbyAdBoostText.text = "획득 가능!\n" + GameManager.instance.boostRewardTakeNum.ToString() + "/5";
            }
            else lobbyAdBoostText.text = "획득 완료\n5/5";
        }
    }
    ...
    {
        if (lobbyAdDiamondText.text[3] == '가') lobbyAdDiamondAskPanel.SetActive(true);
    }
    ...
    {
        if (lobbyAdBoostText.text[3] == '가') lobbyAdBoostAskPanel.SetActive(true);
    }
